...
public class FileOperations {
    ...
    public final static String passwordFilePattern = "mychatapp_%s_password.txt";
    public final static String newestMessageFilePattern = "mychatapp_%s_newestMessage.txt";
